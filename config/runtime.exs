...
#
#     PHX_SERVER=true bin/mudan start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :mudan, MudanWeb.Endpoint, server: true
end

config :mudan, MudanWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  config :mudan, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :mudan, MudanWeb.Endpoint,
